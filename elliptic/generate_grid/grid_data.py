...
def cfgs_print(cfgs: dict):
    ...
    cur_method = next(iter(cfgs.get('method', {}).keys()), '')
    print(f"methon is {cur_method}")
    if (cur_method == 'tfi'):
        pass
    else:
        print(f"coef: {cfgs['method'][cur_method]['coef']}")
        print(f"weight:   {cfgs['method'][cur_method]['weight']}")
        print(f"iter_err: {cfgs['method'][cur_method]['iter_err']}")
        print(f"max_iter: {cfgs['method'][cur_method]['max_iter']}")
